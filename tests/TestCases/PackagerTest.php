...
class PackagerTest extends TestCase
{
     ...
     * @return void
     */
    public function testConstructor_Invalid_Precision_Value()
    {
     ...
     * @return void
     */
    public function testConstructor_Invalid_SortMethod_Value()
    {
        $this->expectException(\UnexpectedValueException::class);
     ...
     * @return void
     */
    public function testGetLowerBounds()
    {
        $this->packager->addBins([
            new Bin($this->binFixture->bin1Id, $this->binFixture->bin1Length, $this->binFixture->bin1Height,
                $this->binFixture->bin1Breadth, $this->binFixture->bin1Weight),
            new Bin($this->binFixture->bin2Id, $this->binFixture->bin2Length, $this->binFixture->bin2Height,
                $this->binFixture->bin2Breadth, $this->binFixture->bin2Weight),
        ]);

        $this->packager->addItems([
            new Item($this->itemFixture->item1Id, $this->itemFixture->item1Length, $this->itemFixture->item1Height,
                $this->itemFixture->item1Breadth, $this->itemFixture->item1Weight),
            new Item($this->itemFixture->item2Id, $this->itemFixture->item2Length, $this->itemFixture->item2Height,
                $this->itemFixture->item2Breadth, $this->itemFixture->item2Weight),
            new Item($this->itemFixture->item3Id, $this->itemFixture->item3Length, $this->itemFixture->item3Height,
                $this->itemFixture->item3Breadth, $this->itemFixture->item3Weight),
            new Item($this->itemFixture->item4Id, $this->itemFixture->item4Length, $this->itemFixture->item4Height,
                $this->itemFixture->item4Breadth, $this->itemFixture->item4Weight),
            new Item($this->itemFixture->item5Id, $this->itemFixture->item5Length, $this->itemFixture->item5Height,
                $this->itemFixture->item5Breadth, $this->itemFixture->item5Weight),
        ]);

        $lowerBounds = $this->packager->getLowerBounds();
        $this->assertEquals(1, $lowerBounds);
    }
     ...
     * @return void
     */
    public function testGetTotalBinsVolume()
    {
        $bin1 = new Bin($this->binFixture->bin1Id, $this->binFixture->bin1Length, $this->binFixture->bin1Height,
            $this->binFixture->bin1Breadth, $this->binFixture->bin1Weight);
        $bin2 = new Bin($this->binFixture->bin2Id, $this->binFixture->bin2Length, $this->binFixture->bin2Height,
            $this->binFixture->bin2Breadth, $this->binFixture->bin2Weight);
        $this->packager->addBins([
            $bin1,
            $bin2,
     ...
     * @return void
     */
    public function testGetTotalBinsWeight()
    {
        $bin1 = new Bin($this->binFixture->bin1Id, $this->binFixture->bin1Length, $this->binFixture->bin1Height,
            $this->binFixture->bin1Breadth, $this->binFixture->bin1Weight);
        $bin2 = new Bin($this->binFixture->bin2Id, $this->binFixture->bin2Length, $this->binFixture->bin2Height,
     ...
     * @return void
     */
    public function testGetTotalItemsVolume()
    {
        $item1 = new Item($this->itemFixture->item1Id, $this->itemFixture->item1Length, $this->itemFixture->item1Height,
            $this->itemFixture->item1Breadth, $this->itemFixture->item1Weight);
        $item2 = new Item($this->itemFixture->item2Id, $this->itemFixture->item2Length, $this->itemFixture->item2Height,
            $this->itemFixture->item2Breadth, $this->itemFixture->item2Weight);
        $item3 = new Item($this->itemFixture->item3Id, $this->itemFixture->item3Length, $this->itemFixture->item3Height,
            $this->itemFixture->item3Breadth, $this->itemFixture->item3Weight);
        $item4 = new Item($this->itemFixture->item4Id, $this->itemFixture->item4Length, $this->itemFixture->item4Height,
            $this->itemFixture->item4Breadth, $this->itemFixture->item4Weight);
        $item5 = new Item($this->itemFixture->item5Id, $this->itemFixture->item5Length, $this->itemFixture->item5Height,
            $this->itemFixture->item5Breadth, $this->itemFixture->item5Weight);
     ...
     * @return void
     */
    public function testGetTotalItemsWeight()
    {
        $item1 = new Item($this->itemFixture->item1Id, $this->itemFixture->item1Length, $this->itemFixture->item1Height,
            $this->itemFixture->item1Breadth, $this->itemFixture->item1Weight);
        $item2 = new Item($this->itemFixture->item2Id, $this->itemFixture->item2Length, $this->itemFixture->item2Height,
     ...
     * @return void
     */
    public function testAddBins_Unique_Bins_Identifier()
    {
        $this->packager->addBins([
            new Bin($this->binFixture->bin1Id, $this->binFixture->bin1Length, $this->binFixture->bin1Height,
                $this->binFixture->bin1Breadth, $this->binFixture->bin1Weight),
     ...
     * @return void
     */
    public function testAddBins_Duplicate_Bins_Identifier()
    {
        $this->expectException(\UnexpectedValueException::class);
        ...
        $this->packager->addBins([
            new Bin($this->binFixture->bin1Id, $this->binFixture->bin1Length, $this->binFixture->bin1Height,
                $this->binFixture->bin1Breadth, $this->binFixture->bin1Weight),
            new Bin($this->binFixture->bin1Id, $this->binFixture->bin2Length, $this->binFixture->bin2Height,
                $this->binFixture->bin2Breadth, $this->binFixture->bin2Weight),
        ]);
    }
     ...
     * @return void
     */
    public function testAddItems_Unique_Items_Identifier()
    {
        $this->packager->addItems([
            new Item($this->itemFixture->item1Id, $this->itemFixture->item1Length, $this->itemFixture->item1Height,
                $this->itemFixture->item1Breadth, $this->itemFixture->item1Weight),
     ...
     * @return void
     */
    public function testAddItems_Duplicate_Items_Identifier()
    {
        $this->expectException(\UnexpectedValueException::class);
        ...
        $this->packager->addItems([
            ...
            new Item($this->itemFixture->item2Id, $this->itemFixture->item2Length, $this->itemFixture->item2Height,
                $this->itemFixture->item2Breadth, $this->itemFixture->item2Weight),
            new Item($this->itemFixture->item1Id, $this->itemFixture->item3Length, $this->itemFixture->item3Height,
                $this->itemFixture->item3Breadth, $this->itemFixture->item3Weight),
            new Item($this->itemFixture->item4Id, $this->itemFixture->item4Length, $this->itemFixture->item4Height,
                $this->itemFixture->item4Breadth, $this->itemFixture->item4Weight),
            new Item($this->itemFixture->item5Id, $this->itemFixture->item5Length, $this->itemFixture->item5Height,
     ...
     * @return void
     */
    public function testPackMethod_All_Items_Fitted_Into_One_Bin()
    {
        $this->packager->addBins([
            new Bin($this->binFixture->bin1Id, $this->binFixture->bin1Length, $this->binFixture->bin1Height,
                $this->binFixture->bin1Breadth, $this->binFixture->bin1Weight),
        ...
        $this->packager->addItems([
            ...
            new Item($this->itemFixture->item5Id, $this->itemFixture->item5Length, $this->itemFixture->item5Height,
                $this->itemFixture->item5Breadth, $this->itemFixture->item5Weight),
            new Item($this->itemFixture->item6Id, $this->itemFixture->item6Length, $this->itemFixture->item6Height,
                $this->itemFixture->item6Breadth, $this->itemFixture->item6Weight),
            new Item($this->itemFixture->item7Id, $this->itemFixture->item7Length, $this->itemFixture->item7Height,
                $this->itemFixture->item7Breadth, $this->itemFixture->item7Weight),
        ]);
     ...
     * @return void
     */
    public function testPackMethod_All_Items_Fitted_Into_Two_Bins()
    {
        $this->packager->addBins([
            new Bin($this->binFixture->bin1Id, $this->binFixture->bin1Length, $this->binFixture->bin1Height,
                $this->binFixture->bin1Breadth, $this->binFixture->bin1Weight),
        ...
        $this->packager->addItems([
            ...
            new Item($this->itemFixture->item7Id, $this->itemFixture->item7Length, $this->itemFixture->item7Height,
                $this->itemFixture->item7Breadth, $this->itemFixture->item7Weight),
            new Item($this->itemFixture->item8Id, $this->itemFixture->item8Length, $this->itemFixture->item8Height,
                $this->itemFixture->item8Breadth, $this->itemFixture->item8Weight),
            new Item($this->itemFixture->item9Id, $this->itemFixture->item9Length, $this->itemFixture->item9Height,
                $this->itemFixture->item9Breadth, $this->itemFixture->item9Weight),
        ]);
     ...
     * @return void
     */
    public function testPackMethod_Not_All_Items_Fitted_Into_Two_Bins()
    {
        $this->packager->addBins([
            new Bin($this->binFixture->bin1Id, $this->binFixture->bin1Length, $this->binFixture->bin1Height,
                $this->binFixture->bin1Breadth, $this->binFixture->bin1Weight),
        ...
        $this->packager->addItems([
            ...
            new Item($this->itemFixture->item9Id, $this->itemFixture->item9Length, $this->itemFixture->item9Height,
                $this->itemFixture->item9Breadth, $this->itemFixture->item9Weight),
            new Item($this->itemFixture->item10Id, $this->itemFixture->item10Length, $this->itemFixture->item10Height,
                $this->itemFixture->item10Breadth, $this->itemFixture->item10Weight),
        ]);
